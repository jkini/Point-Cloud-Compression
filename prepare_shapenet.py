...
def generate_path_txt(pcd_dir, output_dir, sample_strategy):
    ...
    train_path = subdivide_train_path
    test_path = subdivide_test_path
    val_path = subdivide_val_path
    # generate txt file
...
if __name__ == '__main__':
    ...
    with open('data/shapenet/sample_strategy.txt') as f:
        data = f.read()
    sample_strategy = ast.literal_eval(data)
