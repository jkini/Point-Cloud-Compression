...
def search_path(data_root, seq):
    ...
    #seq_dir = [os.path.join('/newton/datasets/KITTI/data/crcv/kitti_t_o/training/velodyne', s) for s in seq if os.path.isdir(os.path.join('/newton/datasets/KITTI/data/crcv/kitti_t_o/training/velodyne', s))]
    pcd_path = []
    for dir in seq_dir:
...
if __name__ == '__main__':
    ...
    #dataset_args.data_root = os.path.join(dataset_args.data_root, 'sequences')
